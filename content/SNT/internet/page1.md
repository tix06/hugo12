---
Title : généralités
description: usage d'internet, les formes de communication
weight: 10
---

* {{% badge color="green" icon="heart" %}}culture numer{{% /badge %}} généralités sur l'usage d'internet: [Lien](../page1)
* {{% badge color="green" icon="heart" %}}culture numer{{% /badge %}} réseau local et reseau internet: [Lien](../page2)
* {{% badge color="green" icon="heart" %}}culture numer{{% /badge %}} circulation des données, protocoles: [Lien](../page3)
* {{% badge color="green" icon="heart" %}}culture numer{{% /badge %}} le cloud: [Lien](..page5)
* {{% badge color="orange" icon="star" %}}competences{{% /badge %}} TP simulation d'un reseau d'ordinateurs: [Lien](../TP_reseau)
...
Avant l'accès généralisé à l'internet, le particulier s'équipait d'un ordinateur pour faire du traitement de texte et des jeux.
...
Voir chapitre sur les [moteur de recherche](../../web/page4).
...
La bonne pratique est de [créer du contenu sur votre site](../../web/page4) ou page web et ensuite de le diffuser sur les réseaux sociaux. En effet, la communication sur les réseaux sociaux est éphémère. Si votre *tweet* ou votre *post* n’est pas vu au moment de sa publication, ce contenu sera perdu tandis que le contenu sur votre site internet restera et contribuera au *bon référencement naturel* de celui-ci.

# Aspects techniques : fonctionnement d'internet

Voir la page [fonctionnement d'internet, prococoles](/docs/SNT_2nde/pages/page3/fonctionnement/)
