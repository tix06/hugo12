...
description: ASTEP, exoplanetes, sequences
weight: 81
---
...
# Tutoriels
* Explorateur de dossiers/fichiers en ligne de commande (python): [TP de term](../../architecture/page11/)
* Lire les données d'un fichier *csv*: [python - entrées/sorties - lire csv](/python_avance/ES/page1/)
* Ecrire des données (table) dans un fichier: [python - entrées/sorties - ecrire](/python_avance/ES/page1/)
* Sauvegarder une liste/dictionnaire dans un fichier: [python - entrées/sorties, module pickle](/python_avance/ES/page1/)
* Tracer un graphique avec matplolib: [matplotlib.pyplot](/python_avance/traitement/page1/)
* Lissage de courbe bruitée: [tuto moyenne glissante](../../structure/page11/)
* Regression linéaire: [tuto](/python_avance/traitement/page2/)
* Pandas dataframe: [tuto](/python_avance/types/page12/)
...
3. Traitement de données en table - Pandas Dataframe: [Lien](/python_avance/types/page12)
4. Base de données:
	* SQL et python: [Lien](/python_avance/traitement/page31)
	* Base de données SQL et python-pandas: [Lien](/python_avance/traitement/page3)
5. indice similarité avec la Terre (IST): [Lien](/python_avance/traitement/page4/)
6. Analyse graphique: [Lien](/python_avance/traitement/page5/)
7. Utiliser scikit-learn pour predire la classe des exoplanètes: [Lien](/python_avance/traitement/page6/)
